...
class dataCreate:
    ...
    def calcInput_Formation01(self, step, relativeState, targetx, targety):
        ...
        if step > 500:
            ...
            self.velocity[0, 0], self.velocity[1, 0] = self.pidControl(relativeState[0, 0, 1], relativeState[1, 0, 1], targetx, targety)
            self.velocity[2, 0] = 0
        return self.velocity
